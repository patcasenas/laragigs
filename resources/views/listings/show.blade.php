        ...
        <x-card>
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <div>
                    ...
                    <div class="text-lg space-y-6">{{$listing->description}}</div>
                    <a href="mailto:{{$listing->email}}" class="block bg-laravel text-white mt-6 py-2 rounded-xl hover:opacity-80">
                        <i class="fa-solid fa-envelope"></i>
                        Contact Employer
                    </a>
                    
                    <a href="{{$listing->website}}" target="_blank" class="block bg-black text-white mt-6 py-2 rounded-xl hover:opacity-80">
